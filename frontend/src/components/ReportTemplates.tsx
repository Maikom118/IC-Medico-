...
useEffect(() => {
  async function loadTemplates() {
    const res = await fetch('https://iamedbr.com/laudos/base');
...
for (const [key, value] of formData.entries()) {
  console.log(key, value);
    ...
    const response = await fetch("https://iamedbr.com/laudos/base", {
      method: "POST",
...
for (const pair of formData.entries()) {
  ...
  const response = await fetch('https://iamedbr.com/laudos/paciente', {
    method: 'POST',
    body: formData, // ⚠️ SEM headers
  });
